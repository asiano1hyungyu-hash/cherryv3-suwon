...
import { suwonData } from '../src/templates/v3/data/suwonData';
...
async function prerender() {
  ...
  // Render full V3 Component Tree for Suwon
  const appHtml = renderToString(<TemplateV3 data={suwonData} />);
  ...
  console.log('✅ Successfully prerendered Suwon V3 page into dist/index.html');
}
